          ...
          <div className="flex-1 px-2.5 py-2 min-w-0">
            ...
            {(property.brochureUrl || property.mapUrl || property.floorPlanUrl || property.demographicReportUrl) && (
              <div className="flex items-center gap-1.5 mt-1.5">
                ...
                {property.demographicReportUrl && (
                  <button
                    onClick={e => { e.stopPropagation(); window.open(property.demographicReportUrl, '_blank', 'noopener'); }}
                    title="Open demographic report"
                    className="w-6 h-6 flex items-center justify-center rounded transition-colors hover:bg-indigo-50"
                    style={{ color: '#4f46e5' }}
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
